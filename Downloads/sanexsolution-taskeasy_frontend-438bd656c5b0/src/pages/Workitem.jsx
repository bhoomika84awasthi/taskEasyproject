  ...
  return (
    ...
    >
      <div className="relative flex h-screen w-full flex-col group/design-root">
        {/* Header */}
        <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-gray-200 dark:border-gray-700 px-6 py-3 bg-white dark:bg-background-dark z-10 shrink-0">
          ...
          <div className="flex flex-1 justify-end gap-4 items-center">
            <label className="flex flex-col min-w-40 !h-10 w-full max-w-sm">
              <div className="flex w-full flex-1 items-stretch rounded-lg h-full">
                ...
                <input
                  className="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-gray-900 dark:text-white focus:outline-0 focus:ring-0 border-none bg-gray-100 dark:bg-gray-800 h-full placeholder:text-gray-500 dark:placeholder:text-gray-400 px-4 rounded-l-none border-l-0 pl-2 text-sm font-normal leading-normal"
                  placeholder="Search..."
                  defaultValue=""
                />
              </div>
        ...
        <div className="flex flex-1 overflow-hidden">
          {/* Sidebar */}
          <aside className="flex h-full w-64 shrink-0 flex-col justify-between bg-white dark:bg-background-dark p-4 border-r border-gray-200 dark:border-gray-700">
            <div className="flex flex-col gap-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="bg-purple-600 size-10 rounded-lg flex items-center justify-center" style={{ width: 40, height: 40 }}>
                    <span className="text-white font-bold text-xl">P</span>
                  </div>
                  <div className="flex flex-col">
                    <h1 className="text-gray-900 dark:text-white text-base font-semibold leading-normal">ProdigiSign</h1>
                  </div>
                </div>
                <button className="p-1.5 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700">
                  <Material className="text-gray-600 dark:text-gray-300">add</Material>
                </button>
              </div>

              <nav className="flex flex-col gap-1">
                <div className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer">
                  <Material className="text-gray-600 dark:text-gray-300 text-xl">space_dashboard</Material>
                  <p className="text-gray-700 dark:text-gray-200 text-sm font-medium leading-normal">Overview</p>
                </div>

                <div className="flex items-center gap-3 px-3 py-2 rounded-lg text-primary bg-primary/10 dark:bg-primary/20 dark:text-white">
                  <Material className="text-xl">view_kanban</Material>
                  <p className="font-semibold text-sm leading-normal">Boards</p>
                </div>

                <div className="pl-8 flex flex-col gap-0.5">
                  <div className="flex items-center gap-3 px-3 py-2 rounded-lg bg-gray-100 dark:bg-gray-700 relative">
                    <div className="absolute left-0 top-0 bottom-0 w-1 bg-primary rounded-r-full" />
                    <p className="text-gray-900 dark:text-white text-sm font-semibold leading-normal">Work Items</p>
                  </div>

                  {['Boards', 'Backlogs', 'Sprints', 'Queries', 'Delivery Plans', 'Time Log Summary'].map((t) => (
                    <div key={t} className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer">
                      <p className="text-gray-700 dark:text-gray-200 text-sm font-medium leading-normal">{t}</p>
                    </div>
                  ))}
                </div>

                <div className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer">
                  <Material className="text-gray-600 dark:text-gray-300 text-xl">webhook</Material>
                  <p className="text-gray-700 dark:text-gray-200 text-sm font-medium leading-normal">Pipelines</p>
                </div>

                <div className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer">
                  <Material className="text-gray-600 dark:text-gray-300 text-xl">inventory_2</Material>
                  <p className="text-gray-700 dark:text-gray-200 text-sm font-medium leading-normal">Artifacts</p>
                </div>
              </nav>
            </div>
            ...
            <div className="flex flex-col gap-1">
              <div className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer">
                <Material className="text-primary text-xl">settings</Material>
                <p className="text-primary text-sm font-medium leading-normal">Project settings</p>
              </div>
            </div>
          </aside>
          ...
          <main className="flex-1 flex flex-col bg-background-light dark:bg-background-dark overflow-auto">
            <div className="flex flex-col gap-4 px-8 py-8 min-h-[600px]">
              <div className="flex justify-between items-center gap-4">
                <div className="flex gap-2 items-center">
                  <button className="px-3 py-1.5 text-sm font-medium text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md hover:bg-gray-50 dark:hover:bg-gray-700">
                    My activity
                  </button>
                  ...
                  <button className="px-3 py-1.5 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md">
                    Open in Queries
                  </button>
                  <button className="px-3 py-1.5 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md">
                    Column Options
                ...
                <div className="flex gap-1">
                  <button className="p-2 text-gray-600 dark:text-gray-300 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700">
              ...
              <div className="flex justify-between items-center gap-2">
                <label className="flex flex-col min-w-40 h-10 w-full max-w-xs">
                  <div className="flex w-full flex-1 items-stretch rounded-lg h-full">
                    <div className="text-gray-500 dark:text-gray-400 flex bg-white dark:bg-gray-800 items-center justify-center pl-3 rounded-l-lg border border-r-0 border-gray-300 dark:border-gray-600">
                      <Material>search</Material>
                    </div>
                    <input
                      className="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-gray-900 dark:text-white focus:outline-0 focus:ring-0 border border-l-0 border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 h-full placeholder:text-gray-500 dark:placeholder:text-gray-400 px-4 rounded-l-none pl-2 text-sm font-normal leading-normal"
                ...
                <div className="flex gap-2">
                  {['Types', 'Assigned to', 'State', 'Area Path', 'Tags'].map((b) => (
                    <button
                      key={b}
                      className="px-3 py-1.5 text-sm font-medium text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md hover:bg-gray-50 dark:hover:bg-gray-700 flex items-center gap-1.5"
                    >
              ...
              <div className="overflow-x-auto bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg table-wrapper">
                  ...
                  <tbody>
                    {[
                      ...
                      <tr key={row.id} className="bg-white dark:bg-gray-800 border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                        ...
                        <td className="px-6 py-4 font-medium text-gray-900 dark:text-white whitespace-nowrap">{row.title}</td>
      ...
      <style>{`
        ...
        *::-webkit-scrollbar-thumb:hover {
        ...
        /* slightly darker tracks/thumbs for dark mode */
        .dark *::-webkit-scrollbar-track { background: #0b1220; }
        .dark *::-webkit-scrollbar-thumb { background: #2b3945; border-color: #0b1220; }
