          ...
          <div className="w-full max-w-6xl mx-auto">
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {projects && projects.length ? (
                projects.map((proj) => (
                  <div key={proj._id || proj.title} className="flex flex-col rounded-xl border border-border-light dark:border-border-dark bg-foreground-light dark:bg-foreground-dark p-6 transition-shadow hover:shadow-lg">
