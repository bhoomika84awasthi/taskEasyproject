...
export default function Summary() {
  ...
  useEffect(() => {
    // if project not passed in state, try to read from query param and fetch
    if (project) return;
    ...
    const fetchProject = async () => {
      try {
        ...
        console.error('Failed to fetch project by id', err?.response?.data || err.message || err);
      }
    };
  ...
  const projectTitle = project?.title || project?.name || 'ProdigiSign';
          ...
          <div className="flex h-full flex-col justify-between p-4">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1 mt-4">
                ...
                <Link to={`/Wiki`} state={{ project }} className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-[#f0f2f4]">
              ...
              <div className="flex flex-col gap-1 mt-2">
                <Link to={`/Board`} className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-[#f0f2f4]">
